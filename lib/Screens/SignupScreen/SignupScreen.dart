          ...
          child: Column(
            ...
            children: [
              ...
              customButton(buttonName: "SIGN UP",onTap: (){
                ...
                API.internal().signupUser(emailController.text, passwordController.text,(message , code) {
                  context.read<LoaderViewCubit>().hideLoader();
                  GlobalFunctions.showAlertMessage(context: context,
              ...
              ElevatedButton(
                  onPressed: ()  async {
                      await API.instance.signupWithSocial(false);
                  },
              ...
              ElevatedButton(
                  onPressed: () async {
                      await API.instance.signupWithSocial(true);
                  },
                  style: ElevatedButton.styleFrom(
                      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(18)),
                      backgroundColor: Colors.white
