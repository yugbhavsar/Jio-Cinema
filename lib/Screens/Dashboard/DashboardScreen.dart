                      ...
                      child: Row(
                        children: List.generate(3, (index) {
                          return InkWell(
                              ...
                              child: upcomingEventCard(context)
                          );
                        },),
                      ),
                    ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  ElevatedButton(
                                    ...
                                    child: Text("INVITE" ,style: appTextStyle(fontType: FontType.bold , fontSize: 18 , textColor: Colors.white),),
                                  )
                                ],
                              ),
                            ),
...
Widget upcomingEventCard(BuildContext context) {
  return Card(
    color: Colors.white,
    elevation: 2,
    ...
    child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                SvgPicture.asset(AppImages.dbPeopleGroup ,fit: BoxFit.fitWidth,),
